...
export class MenuScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.add
      .text(width / 2, height * 0.18, "DUNDEE RUNNER", {
    ...
    this.add
      .sprite(width / 2, height * 0.38, "crocodile")
      .setScale(0.55)
      .play("idle");

    this.statusText = this.add
      .text(width / 2, height * 0.55, "Загрузка…", {
        fontFamily: "Georgia, 'Times New Roman', serif",
        fontSize: "15px",
    ...
    addPenTextButton(this, width / 2, height * 0.68, "Играть", () => {
      this.scene.start("play");
    });

    addPenTextButton(this, width / 2, height * 0.78, "Магазин VPN", () => {
      void this.openShop();
    });

    addPenTextButton(this, width / 2, height * 0.88, "Открыть VPN-бот", () => {
